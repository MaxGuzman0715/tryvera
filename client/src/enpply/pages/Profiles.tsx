        ...
        <>
          ...
          <div className="card">
            ...
            {profile.experience.length > 0 &&
              !profile.experience.slice(0, 2).some((e) => e.consulting) && (
                <div
                  role="alert"
                  style={{
                    margin: "0 0 12px",
                ...
                >
                  ⚠️ Neither of the last 2 companies is marked <strong>Consulting</strong>. The résumé
                  generator needs at least one consulting company among the two most recent roles to
                  absorb cross-industry / off-profile stacks. Mark the consulting employer below.
                </div>
              )}
            {profile.experience.map((exp, i) => (
              <div key={i} className="exp-block">
                ...
                <label
                  style={{ display: "flex", alignItems: "center", gap: 8, margin: "4px 0 8px", cursor: "pointer" }}
                >
                  <input
                    type="checkbox"
                    checked={!!exp.consulting}
                    onChange={(e) => updateExp(i, { consulting: e.target.checked || undefined })}
                  />
                  Consulting company (client-services / staffing firm)
                </label>
