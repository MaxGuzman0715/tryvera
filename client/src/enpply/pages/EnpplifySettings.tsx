...
const FLAG_META: { key: keyof EnpplifyFeatureFlags; label: string; help: string }[] = [
  ...
  {
    key: "manual_company_role",
    label: "Enter company & role manually",
    help: "Show an “enter company & role manually” toggle in the panel. With it on, a log-only run (no résumé/CV) skips the extraction AI and uses the company/role you type. Off by default.",
  },
];
